...
/*=============================================
Existe dominio en base de datos
=============================================*/
$domain = substr($path,0,-1);

$select = "*";
$url = "relations?rel=codes,landings&type=code,landing&linkTo=domain_landing&equalTo=".urlencode($domain)."&select=".$select;
$method = "GET";
$fields = array();
...
if($page == null && isset($routesArray[0])){
...
<body <?php if (isset($_GET["scroll"]) && $_GET["scroll"] == "custom"): ?> class="custom-scroll" <?php endif ?> >
	...
	<?php else: ?>
		...
		<?php include "modules/sidebar-right.php"; ?>
