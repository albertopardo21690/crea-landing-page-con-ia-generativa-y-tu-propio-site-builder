	...
	public function landingsManage(){
		...
		if(isset($_POST["title_landing"])){
			...
			$fields = array(
				...
				"url_landing" => urlencode($_POST["url_landing"]),
				"plugins_landing" => json_encode($plugins_landing),
				"icon_landing" => urlencode(trim($_POST["icon_landing"])),
				"cover_landing" => urlencode(trim($_POST["cover_landing"])),
				"description_landing" => urlencode(trim($_POST["description_landing"])),
